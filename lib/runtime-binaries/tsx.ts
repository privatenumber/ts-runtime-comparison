...
export default createRuntime({
	...
	performance: {
		...
		diskCache: link(PASS, 'https://github.com/esbuild-kit/tsx#cache'),
	},
	dx: {
		tsRepl: link(PASS, 'https://github.com/esbuild-kit/tsx#repl'),
		watchMode: link(PASS, 'https://github.com/esbuild-kit/tsx#watch-mode'),
		typeChecking: FAIL,
		hidesWarnings: PASS,
